...
slideRight(element,duration=200){this.slide(element,duration,-100,0,"block");}}
...
class FabrSelector extends FabrCoreComponent{constructor(){super();this.componentName="FabrSelector";this.componentStyleClass="fabr-selector";this.selector="[fabr-selector]";this.eventMap={};this.animateHelper=new FabrHelperAnimate();this.animateHelper.init(this);this.iconHelper=new FabrHelperIcon();this.iconHelper.init(this);this.iconHelper.setIconsLibraryMaterial();}
...
if(event.key==="Enter"){event.preventDefault();if(activeItem){activeItem.click();}}}}
class FabrExpander extends FabrCoreComponent{constructor(){super();this.componentName="FabrExpander";this.componentStyleClass="fabr-expander";this.selector="[fabr-expander]";this.eventMap={};this.animateHelper=new FabrHelperAnimate();this.animateHelper.init(this);this.iconHelper=new FabrHelperIcon();this.iconHelper.init(this);this.iconHelper.setIconsLibraryMaterial();}
...
this.animateHelper.fadeIn(content,300);content.classList.add("fabr-expander-content-open");icon.textContent="keyboard_arrow_up";}}
class Fabr extends FabrCore{constructor(){super();console.log("%cFabr initializing...","color: #00f");this.components={form:new FabrForm(),link:new FabrLink(),list:new FabrList(),counter:new FabrCounter(),expander:new FabrExpander(),tooltip:new FabrTooltip(),notebook:new FabrNotebook(),table:new FabrTable(),animator:new FabrAnimator(),snippet:new FabrSnippet(),selector:new FabrSelector(),};this.init();console.log("%cFabr initialized","color: #00f");}
