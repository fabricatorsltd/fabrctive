...
initEventListeners(){for(let[event,fn]of Object.entries(this.eventMap)){this.elements.forEach((element)=>{element.addEventListener(event,(e)=>{this[fn](e);});});}}}
...
class Reactive extends ReactiveCore{constructor(){super();this.init();}
init(){this.initForms();this.initLinks();}
