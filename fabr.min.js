...
initElements(){if(!this.selector){this.debugger.log(`No selectors defined.`);return;}
...
class Fabr extends FabrCore{constructor(){super();console.log("%cFabr initializing...","color: #00f");this.init();console.log("%cFabr initialized","color: #00f");}
init(){this.initComponents();}
initComponents(){new FabrForm().init();new FabrLink().init();new FabrCounter().init();new FabrTooltip().init();new FabrNotebook().init();new FabrTable().init();new FabrAnimator().init();new FabrSnippet().init();}}